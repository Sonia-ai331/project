...
# получает url адрес новости
def get_url_news():
    for count in range(1, 12):
        url = f'https://sch18vo.ru/news/?PAGEN_1={count}'
...
# получает данные новости
for card_url in get_url_news():
    ...
    new = data.find('div', class_='bx-newsdetail-content bvi-tts')
    if day is None:
        continue
    else:
        day = day.text
